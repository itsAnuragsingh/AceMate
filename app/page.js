  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gray-900 gap-4">
      ...
      <div className="w-1/2 h-1/3 space-y-2 border-2 border-gray-700 rounded-lg flex flex-col px-3 py-4  bg-gray-800 lg:w-1/4">
        ...
        <p className="text-gray-200 text-lg">AceMate is an AI-powered all-in-one learning assistant that helps students and professionals prepare for success. From mock interviews to instant note-making from PDFs and quiz generation – it’s everything you need, in one smart platform.</p>
      </div>
    </div>
  );
}
